...
const SvgFlipH = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      className="flip-h_svg__uim-quaternary"
    />
    <path d="m12 21 5-5H7z" className="flip-h_svg__uim-primary" />
    <path
      d="M12 22a1 1 0 0 1-.707-.293l-5-5A1 1 0 0 1 7 15h10a1 1 0 0 1 .707 1.707l-5 5A1 1 0 0 1 12 22m-2.586-5L12 19.586 14.586 17Z"
      className="flip-h_svg__uim-primary"
    />
    <path
      ...
      className="flip-h_svg__uim-tertiary"
    />
  </svg>
)
