...
const SvgStoreSlash = (
  ...
  >
    <path
      ...
      className="store-slash_svg__uim-quaternary"
    />
    <path
      d="M22 23a1 1 0 0 1-.707-.293l-20-20a1 1 0 0 1 1.414-1.414l20 20A1 1 0 0 1 22 23"
      className="store-slash_svg__uim-primary"
    />
    <path
      d="M12.586 14H10a1 1 0 0 0-1 1v7h6v-5.586Z"
      className="store-slash_svg__uim-secondary"
    />
    <path
    ...
    <path
      ...
      className="store-slash_svg__uim-tertiary"
    />
  </svg>
)
